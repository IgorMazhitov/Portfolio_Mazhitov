  ...
  return (
    <div className="absolute top-0 w-full flex flex-row justify-between items-center p-4 font-sans text-lg">
      ...
      <div className=" flex flex-row justify-evenly items-center w-96">
        <div className=" ml-1 flex flex-row items-center justify-center w-20 cursor-pointer bg-transparent transition-all hover:-translate-y-1 hover:border-b-2 hover:border-stone-500">
          ...
          <p className="ml-1"> Main </p>
        </div>

        <div className=" ml-1 flex flex-row items-center justify-center cursor-pointer bg-transparent transition-all hover:-translate-y-1 hover:border-b-2 hover:border-stone-500">

...
const initialState = {
  softSkills:
    "SOFT_RIGHT flex flex-col justify-between items-between gap-1 absolute bg-teal-400 text-3xl transition-all duration-300 w-1/2 opacity-0 top-72 right-0 z-0 overflow-hidden",
  soft1:
